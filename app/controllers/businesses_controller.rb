class BusinessesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @business.save
        format.html { redirect_to action: "index", notice: 'Business was successfully created.' }
  ...
  def update
    respond_to do |format|
      if @business.update(business_params)
        format.html { redirect_to show_business_path(@business), notice: 'Business was successfully updated.' }
  ...
  def destroy
    @business.destroy
    respond_to do |format|
      format.html { redirect_to business_path }
      format.json { head :no_content }
    end
  end
