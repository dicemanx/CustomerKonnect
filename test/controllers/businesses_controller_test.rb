...
class BusinessesControllerTest < ActionController::TestCase
  ...
  test "should create business" do
    assert_difference('Business.count') do
      post :create, business: { address: @business.address, email: @business.email, name: @business.name, profile: @business.profile }
    end
  ...
  test "should update business" do
    patch :update, id: @business, business: { address: @business.address, email: @business.email, name: @business.name, profile: @business.profile }
    assert_redirected_to business_path(assigns(:business))
  end
